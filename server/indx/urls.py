...
from indx.views import package_list, package_redirect, package_info, version_info, dependency_tree
...
urlpatterns = [
    ...
    #url(r'^(?P<name>{0:s})/(?P<v>[^.][a-zA-Z0-9_\-.]+)/tree$'.format(settings.PACKAGE_NAME_PATTERN), dependency_tree, name = 'dependency_tree'),  # impossible, don't know which subversions
]
